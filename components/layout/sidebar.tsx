...
import { LayoutDashboard, FolderKanban, Heart, ShoppingBag, MessageSquare, Settings, Image, FileText, DollarSign, Package, Warehouse, Users, UserCheck, Store, ShieldCheck, BarChart3, ChevronLeft, LogOut, HelpCircle, AlertTriangle, Wallet, Search, Calendar } from "lucide-react";
import { cn } from "@/lib/utils";
import { NavItem } from "@/lib/types";
import { Avatar, Badge, Separator } from "@/components/ui";

const iconMap: Record<string, React.ComponentType<{ className?: string }>> = { LayoutDashboard, FolderKanban, Heart, ShoppingBag, MessageSquare, Settings, Image, FileText, DollarSign, Package, Warehouse, Users, UserCheck, Store, ShieldCheck, BarChart3, AlertTriangle, Wallet, Search, HelpCircle, Calendar };
