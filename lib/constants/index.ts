...
export const dashboardNavItems: NavItem[] = [
  ...
  { title: "Wishlist", href: "/wishlist", icon: "ShoppingCart" },
...
export const designerNavItems: NavItem[] = [
  ...
  { title: "Invoices", href: "/designer-invoices", icon: "FileText" },
  { title: "Analytics", href: "/designer-analytics", icon: "BarChart3" },
  { title: "Verification", href: "/designer-verification", icon: "ShieldCheck" },
  { title: "Consultations", href: "/designer-consultations", icon: "Calendar" },
  { title: "Analytics", href: "/vendor-analytics", icon: "BarChart3" },
  { title: "Consultation Setup", href: "/consultation-settings", icon: "Calendar" },
  { title: "Consultation Setup", href: "/consultation-settings", icon: "Calendar" },
  { title: "Availability", href: "/availability", icon: "Calendar" },
  { title: "Store Plans", href: "/vendor-subscription", icon: "Star" },
