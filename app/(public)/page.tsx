    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-earth-900 via-earth-800 to-terracotta-900 text-white">
        <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-32 relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold leading-tight max-w-3xl">Find Verified Interior Designers in Africa</h1>
          <p className="mt-4 text-base lg:text-lg text-white/80 max-w-xl">Connect with top designers, manage projects, and pay securely through escrow. No scams, no guesswork.</p>
