    ...
    <div className="space-y-6"><h1 className="text-2xl font-bold">Settings</h1>
      <div className="flex gap-6 flex-col lg:flex-row">
        ...
        <div className="flex-1 max-w-2xl">
          ...
          {tab === "security" && <Card><CardHeader><CardTitle>Change Password</CardTitle><p className="text-sm text-muted-foreground">A verification code will be sent to your email</p></CardHeader><CardContent><ChangePasswordForm /></CardContent></Card>}
        </div>
      </div>
    </div>
  );
